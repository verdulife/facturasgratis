...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-e0a728cb.js",
      css: [assets + "/_app/assets/start-c446e5f0.css"],
      js: [assets + "/_app/start-e0a728cb.js", assets + "/_app/chunks/vendor-1bb6e2c0.js", assets + "/_app/chunks/singletons-12a22614.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-f3f11d9c.js", "css": ["assets/pages/__layout.svelte-31d00bb1.css"], "js": ["pages/__layout.svelte-f3f11d9c.js", "chunks/vendor-1bb6e2c0.js", "chunks/stores-a06af009.js", "chunks/stores-dc0795db.js", "chunks/utils-004f515d.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-3839aa3e.js", "css": [], "js": ["error.svelte-3839aa3e.js", "chunks/vendor-1bb6e2c0.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-35653701.js", "css": ["assets/pages/index.svelte-e9dc129a.css"], "js": ["pages/index.svelte-35653701.js", "chunks/vendor-1bb6e2c0.js", "chunks/utils-004f515d.js"], "styles": [] }, "src/routes/facturas/index.svelte": { "entry": "pages/facturas/index.svelte-7376c8dc.js", "css": ["assets/pages/facturas/index.svelte-9292271a.css"], "js": ["pages/facturas/index.svelte-7376c8dc.js", "chunks/vendor-1bb6e2c0.js", "chunks/stores-dc0795db.js", "chunks/utils-004f515d.js"], "styles": [] }, "src/routes/facturas/nueva.svelte": { "entry": "pages/facturas/nueva.svelte-52023e42.js", "css": ["assets/pages/facturas/nueva.svelte-c6afd4d2.css"], "js": ["pages/facturas/nueva.svelte-52023e42.js", "chunks/vendor-1bb6e2c0.js", "chunks/navigation-51f4a605.js", "chunks/singletons-12a22614.js", "chunks/stores-dc0795db.js"], "styles": [] }, "src/routes/facturas/[id].svelte": { "entry": "pages/facturas/[id].svelte-ee51ff66.js", "css": ["assets/pages/facturas/[id].svelte-b8f50f51.css"], "js": ["pages/facturas/[id].svelte-ee51ff66.js", "chunks/vendor-1bb6e2c0.js", "chunks/stores-a06af009.js", "chunks/navigation-51f4a605.js", "chunks/singletons-12a22614.js", "chunks/stores-dc0795db.js"], "styles": [] }, "src/routes/ajustes/index.svelte": { "entry": "pages/ajustes/index.svelte-87697542.js", "css": ["assets/pages/ajustes/index.svelte-4d04a9e9.css"], "js": ["pages/ajustes/index.svelte-87697542.js", "chunks/vendor-1bb6e2c0.js", "chunks/navigation-51f4a605.js", "chunks/singletons-12a22614.js", "chunks/stores-dc0795db.js"], "styles": [] } };
...
var Facturas = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_bills();
  $$unsubscribe_userData();
  return `${$$result.head += `${$$result.title = `<title>Tus facturas | Facturas gratis</title>`, ""}<meta property="${"og:title"}" content="${"Tus facturas | Facturas gratis"}" data-svelte="svelte-9e3jqr"><meta property="${"og:site_name"}" content="${"Facturas gratis"}" data-svelte="svelte-9e3jqr"><meta name="${"description"}" content="${"Herramientas online y completamente gratuitas para generar, enviar, rectificar y listar facturas, presupuestos, albaranes,\r\n  clientes, proveedores y productos/servicios. No se necesita instalaci\xF3n."}" data-svelte="svelte-9e3jqr"><meta property="${"og:description"}" content="${"Herramientas online y completamente gratuitas para generar, enviar, rectificar y listar facturas, presupuestos, albaranes,\r\n  clientes, proveedores y productos/servicios. No se necesita instalaci\xF3n."}" data-svelte="svelte-9e3jqr">`, ""}

<div class="${"scroll"}"><section class="${"header col fcenter xfill svelte-4exbb6"}"><h1 class="${"svelte-4exbb6"}">${escape(tools[0].title)}</h1>
    <p class="${"svelte-4exbb6"}">${escape(tools[0].desc)}</p></section>

  ${$userData.legal_name !== void 0 ? `<div class="${"list-filter col acenter xfill svelte-4exbb6"}">${billsData.length <= 0 ? `<a class="${"btn succ semi"}" href="${"/facturas/nueva"}">CREA TU PRIMERA FACTURA</a>` : `<a class="${"new-btn btn succ semi svelte-4exbb6"}" href="${"/facturas/nueva"}">NUEVA FACTURA</a>

        <div class="${"row xfill"}"><input type="${"text"}" class="${"out grow"}" placeholder="${"Buscar por nombre o CIF/NIF"}"${add_attribute("value", searchTerm, 0)}>

          <select class="${"out svelte-4exbb6"}"><option value="${""}">Todos los meses</option>${each(months, (month, i) => `<option${add_attribute("value", i, 0)}>${escape(month)}</option>`)}</select>

          <select class="${"out svelte-4exbb6"}"><option value="${""}">Todos los a\xF1os</option>${each(years(), (year) => `<option${add_attribute("value", year, 0)}>${escape(year)}</option>`)}</select></div>`}</div>

    <ul class="${"bill-list col acenter xfill svelte-4exbb6"}">${each(filteredBills, (bill) => `${`${(filterYear === "" ? true : filterYear === bill.date.year) ? `<a href="${"/facturas/" + escape(bill._id)}" class="${"row xfill"}"><li class="${"box round row jbetween xfill svelte-4exbb6"}">${escape(bill.client.legal_name)} <span>${escape(bill.number)}</span></li>
            </a>` : ``}`}`)}</ul>` : `<div class="${"first col acenter xfill svelte-4exbb6"}"><h2>Primeros pasos</h2>
      <p>Para poder empezar a generar facturas, primero tienes que rellenar tus datos</p>
      <br>
      <a href="${"/ajustes"}" class="${"btn pri semi svelte-4exbb6"}">RELLENAR DATOS</a></div>`}
</div>`;
});
...
var Nueva = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_bills();
  $$unsubscribe_userData();
  return `${$$result.head += `${$$result.title = `<title>Crear nueva factura | Facturas gratis</title>`, ""}<meta property="${"og:title"}" content="${"Crear nueva factura | Facturas gratis"}" data-svelte="svelte-1g5fl01"><meta property="${"og:site_name"}" content="${"Facturas gratis"}" data-svelte="svelte-1g5fl01"><meta name="${"description"}" content="${"Herramientas online y completamente gratuitas para generar, enviar, rectificar y listar facturas, presupuestos, albaranes,\r\n  clientes, proveedores y productos/servicios. No se necesita instalaci\xF3n."}" data-svelte="svelte-1g5fl01"><meta property="${"og:description"}" content="${"Herramientas online y completamente gratuitas para generar, enviar, rectificar y listar facturas, presupuestos, albaranes,\r\n  clientes, proveedores y productos/servicios. No se necesita instalaci\xF3n."}" data-svelte="svelte-1g5fl01">`, ""}
...
var U5Bidu5D = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_userData();
  $$unsubscribe_page();
  return `${$$result.head += `${$$result.title = `<title>Editar factura | Facturas gratis</title>`, ""}<meta property="${"og:title"}" content="${"Editar factura | Facturas gratis"}" data-svelte="svelte-4o2sw3"><meta property="${"og:site_name"}" content="${"Facturas gratis"}" data-svelte="svelte-4o2sw3"><meta name="${"description"}" content="${"Herramientas online y completamente gratuitas para generar, enviar, rectificar y listar facturas, presupuestos, albaranes,\r\n  clientes, proveedores y productos/servicios. No se necesita instalaci\xF3n."}" data-svelte="svelte-4o2sw3"><meta property="${"og:description"}" content="${"Herramientas online y completamente gratuitas para generar, enviar, rectificar y listar facturas, presupuestos, albaranes,\r\n  clientes, proveedores y productos/servicios. No se necesita instalaci\xF3n."}" data-svelte="svelte-4o2sw3">`, ""}
...
var Ajustes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_budgets();
  $$unsubscribe_bills();
  return `${$$result.head += `${$$result.title = `<title>Tus datos fiscales | Facturas gratis</title>`, ""}<meta property="${"og:title"}" content="${"Tus datos fiscales | Facturas gratis"}" data-svelte="svelte-1n9vukf"><meta property="${"og:site_name"}" content="${"Facturas gratis"}" data-svelte="svelte-1n9vukf"><meta name="${"description"}" content="${"Herramientas online y completamente gratuitas para generar, enviar, rectificar y listar facturas, presupuestos, albaranes,\r\n  clientes, proveedores y productos/servicios. No se necesita instalaci\xF3n."}" data-svelte="svelte-1n9vukf"><meta property="${"og:description"}" content="${"Herramientas online y completamente gratuitas para generar, enviar, rectificar y listar facturas, presupuestos, albaranes,\r\n  clientes, proveedores y productos/servicios. No se necesita instalaci\xF3n."}" data-svelte="svelte-1n9vukf">`, ""}
...
<div class="${"scroll"}"><section class="${"header col fcenter xfill svelte-1mh7dhf"}"><h1 class="${"svelte-1mh7dhf"}">Tus datos de facturaci\xF3n</h1>
    ...
    ${user && user.legal_id ? `<p class="${"svelte-1mh7dhf"}">Peso: <b>${escape(storageSpace.usage)}kb</b> | Ultima actualizacion: <b>${escape(new Date($userData._updated).toLocaleDateString())}</b></p>` : ``}
