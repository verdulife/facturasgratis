...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-81e985b0.js",
      css: [assets + "/_app/assets/start-c446e5f0.css"],
      js: [assets + "/_app/start-81e985b0.js", assets + "/_app/chunks/vendor-f2c27089.js", assets + "/_app/chunks/singletons-12a22614.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-b800da23.js", "css": ["assets/pages/__layout.svelte-ba8838fe.css"], "js": ["pages/__layout.svelte-b800da23.js", "chunks/vendor-f2c27089.js", "chunks/stores-2736cb01.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-5cc36e42.js", "css": [], "js": ["error.svelte-5cc36e42.js", "chunks/vendor-f2c27089.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-ac8f90c0.js", "css": ["assets/pages/index.svelte-cbad238c.css"], "js": ["pages/index.svelte-ac8f90c0.js", "chunks/vendor-f2c27089.js", "chunks/utils-004f515d.js"], "styles": [] }, "src/routes/facturas/index.svelte": { "entry": "pages/facturas/index.svelte-84e222ac.js", "css": ["assets/pages/facturas/index.svelte-3415a2f1.css"], "js": ["pages/facturas/index.svelte-84e222ac.js", "chunks/vendor-f2c27089.js", "chunks/stores-2736cb01.js", "chunks/utils-004f515d.js"], "styles": [] }, "src/routes/facturas/nueva.svelte": { "entry": "pages/facturas/nueva.svelte-a9e5305f.js", "css": ["assets/pages/facturas/nueva.svelte-8ab68a0b.css"], "js": ["pages/facturas/nueva.svelte-a9e5305f.js", "chunks/vendor-f2c27089.js", "chunks/singletons-12a22614.js", "chunks/stores-2736cb01.js"], "styles": [] }, "src/routes/ajustes/index.svelte": { "entry": "pages/ajustes/index.svelte-d351e26b.js", "css": ["assets/pages/ajustes/index.svelte-16fdfad9.css"], "js": ["pages/ajustes/index.svelte-d351e26b.js", "chunks/vendor-f2c27089.js", "chunks/stores-2736cb01.js"], "styles": [] } };
  ...
  return `<div class="${"scroll"}"><form class="${"bill-data col acenter xfill svelte-689xub"}"><div class="${"box round col xfill svelte-689xub"}"><h2>Datos de la factura</h2>
      ...
      <div class="${"row xfill"}"><div class="${"input-wrapper col grow svelte-689xub"}"><label for="${"legal_name"}" class="${"svelte-689xub"}">N\xFAmero</label>
        ...
        <div class="${"date-row row xhalf svelte-689xub"}"><div class="${"input-wrapper date col svelte-689xub"}"><label for="${"day"}" class="${"svelte-689xub"}">D\xEDa</label>
            <input type="${"number"}" id="${"day"}" class="${"xfill svelte-689xub"}" required${add_attribute("value", billData.date.day, 0)}></div>
          <div class="${"input-wrapper date col svelte-689xub"}"><label for="${"month"}" class="${"svelte-689xub"}">Mes</label>
            <input type="${"number"}" id="${"month"}" class="${"xfill svelte-689xub"}" required${add_attribute("value", billData.date.month, 0)}></div>
  ...
  ${$userData ? `<div class="${"info col acenter xfill svelte-1a0ueg1"}"><div class="${"box round col xfill svelte-1a0ueg1"}"><h2>Logotipo</h2>
      ...
      <div class="${"box round col xfill svelte-1a0ueg1"}"><h2>Impuestos</h2>
        ...
        <div class="${"input-wrapper col xfill svelte-1a0ueg1"}"><label for="${"iva"}" class="${"svelte-1a0ueg1"}">IVA</label>
          <select id="${"iva"}" class="${"xfill svelte-1a0ueg1"}"><option${add_attribute("value", 21, 0)}>21%</option><option${add_attribute("value", 10, 0)}>10%</option><option${add_attribute("value", 4, 0)}>4%</option></select></div>
