...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-2c9fab49.js",
      css: [assets + "/_app/assets/start-c446e5f0.css"],
      js: [assets + "/_app/start-2c9fab49.js", assets + "/_app/chunks/vendor-f2c27089.js", assets + "/_app/chunks/singletons-12a22614.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-c6d1cc4f.js", "css": ["assets/pages/__layout.svelte-ba8838fe.css"], "js": ["pages/__layout.svelte-c6d1cc4f.js", "chunks/vendor-f2c27089.js", "chunks/stores-2736cb01.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-acff3439.js", "css": [], "js": ["error.svelte-acff3439.js", "chunks/vendor-f2c27089.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-ef231962.js", "css": ["assets/pages/index.svelte-cbad238c.css"], "js": ["pages/index.svelte-ef231962.js", "chunks/vendor-f2c27089.js", "chunks/utils-004f515d.js"], "styles": [] }, "src/routes/facturas/index.svelte": { "entry": "pages/facturas/index.svelte-8625e27b.js", "css": ["assets/pages/facturas/index.svelte-5263f3ad.css"], "js": ["pages/facturas/index.svelte-8625e27b.js", "chunks/vendor-f2c27089.js", "chunks/stores-2736cb01.js", "chunks/utils-004f515d.js"], "styles": [] }, "src/routes/facturas/nueva.svelte": { "entry": "pages/facturas/nueva.svelte-faa7363b.js", "css": ["assets/pages/facturas/nueva.svelte-f48450b8.css"], "js": ["pages/facturas/nueva.svelte-faa7363b.js", "chunks/vendor-f2c27089.js", "chunks/singletons-12a22614.js", "chunks/stores-2736cb01.js"], "styles": [] }, "src/routes/ajustes/index.svelte": { "entry": "pages/ajustes/index.svelte-589e6814.js", "css": ["assets/pages/ajustes/index.svelte-16fdfad9.css"], "js": ["pages/ajustes/index.svelte-589e6814.js", "chunks/vendor-f2c27089.js", "chunks/stores-2736cb01.js"], "styles": [] } };
...
var css$5 = {
  code: "nav.svelte-1nrfjse{height:65px;border-bottom:1px solid #e6e6e6;padding:0 40px}@media(max-width: 600px){nav.svelte-1nrfjse{padding:0 20px}}.logo.svelte-1nrfjse{width:200px}li.svelte-1nrfjse{padding:0 20px}.user-img.svelte-1nrfjse{width:40px;height:40px;-o-object-fit:contain;object-fit:contain;-o-object-position:center;object-position:center;border:1px solid #e6e6e6;border-radius:50%;margin-right:10px;padding:3px}.active.svelte-1nrfjse{border-top:2px solid #383838}@media(max-width: 600px){.active.svelte-1nrfjse{border-bottom:none;font-weight:bold}}.mobile-menu.svelte-1nrfjse{display:none}.icon.svelte-1nrfjse{width:25px;height:25px}@media(max-width: 600px){.desktop-menu.svelte-1nrfjse{display:none}.mobile-menu.svelte-1nrfjse{display:inherit}}",
  map: '{"version":3,"file":"Nav.svelte","sources":["Nav.svelte"],"sourcesContent":["<script>\\r\\n  import { page } from \\"$app/stores\\";\\r\\n  import { slide } from \\"svelte/transition\\";\\r\\n  import { userData } from \\"../stores\\";\\r\\n\\r\\n  const routes = [\\r\\n    {\\r\\n      slug: \\"/\\",\\r\\n      title: \\"Inicio\\",\\r\\n    },\\r\\n    {\\r\\n      slug: \\"/ajustes\\",\\r\\n      title: $userData.legal_name || \\"Ajustes\\",\\r\\n    },\\r\\n  ];\\r\\n\\r\\n  let mobileMenu = false;\\r\\n\\r\\n  function togMenu() {\\r\\n    mobileMenu = !mobileMenu;\\r\\n  }\\r\\n<\/script>\\r\\n\\r\\n<nav class=\\"row jbetween acenter xfill\\">\\r\\n  <a href=\\"/\\">\\r\\n    <img class=\\"logo\\" src=\\"/logo.svg\\" alt=\\"facturasgratis\\" />\\r\\n  </a>\\r\\n\\r\\n  <ul class=\\"desktop-menu row yfill\\">\\r\\n    {#each routes as route}\\r\\n      <li class=\\"row acenter yfill\\" class:active={$page.path === route.slug}>\\r\\n        <a href={route.slug} class=\\"row acenter yfill\\">\\r\\n          {#if route.title === $userData.legal_name && $userData.logo}\\r\\n            <img class=\\"user-img\\" src={$userData.logo} alt={$userData.legal_name || \\"Logotipo\\"} />\\r\\n          {/if}\\r\\n\\r\\n          {route.title}\\r\\n        </a>\\r\\n      </li>\\r\\n    {/each}\\r\\n  </ul>\\r\\n\\r\\n  <a class=\\"mobile-menu row fcenter\\" href=\\"/ajustes\\">\\r\\n    {#if $userData.logo}\\r\\n      <img class=\\"user-img\\" src={$userData.logo} alt={$userData.legal_name || \\"Logotipo\\"} />\\r\\n    {:else}\\r\\n      <div class=\\"icon row fcenter\\">\\r\\n        <img class=\\"fill\\" src=\\"/options.svg\\" alt=\\"Men\xFA\\" />\\r\\n      </div>\\r\\n    {/if}\\r\\n  </a>\\r\\n</nav>\\r\\n\\r\\n<style lang=\\"scss\\">nav {\\n  height: 65px;\\n  border-bottom: 1px solid #e6e6e6;\\n  padding: 0 40px;\\n}\\n@media (max-width: 600px) {\\n  nav {\\n    padding: 0 20px;\\n  }\\n}\\n\\n.logo {\\n  width: 200px;\\n}\\n\\nli {\\n  padding: 0 20px;\\n}\\n\\n.user-img {\\n  width: 40px;\\n  height: 40px;\\n  -o-object-fit: contain;\\n     object-fit: contain;\\n  -o-object-position: center;\\n     object-position: center;\\n  border: 1px solid #e6e6e6;\\n  border-radius: 50%;\\n  margin-right: 10px;\\n  padding: 3px;\\n}\\n\\n.active {\\n  border-top: 2px solid #383838;\\n}\\n@media (max-width: 600px) {\\n  .active {\\n    border-bottom: none;\\n    font-weight: bold;\\n  }\\n}\\n\\n.mobile-menu {\\n  display: none;\\n}\\n\\n.icon {\\n  width: 25px;\\n  height: 25px;\\n}\\n\\n@media (max-width: 600px) {\\n  .desktop-menu {\\n    display: none;\\n  }\\n\\n  .mobile-menu {\\n    display: inherit;\\n  }\\n}</style>\\r\\n"],"names":[],"mappings":"AAqDmB,GAAG,eAAC,CAAC,AACtB,MAAM,CAAE,IAAI,CACZ,aAAa,CAAE,GAAG,CAAC,KAAK,CAAC,OAAO,CAChC,OAAO,CAAE,CAAC,CAAC,IAAI,AACjB,CAAC,AACD,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACzB,GAAG,eAAC,CAAC,AACH,OAAO,CAAE,CAAC,CAAC,IAAI,AACjB,CAAC,AACH,CAAC,AAED,KAAK,eAAC,CAAC,AACL,KAAK,CAAE,KAAK,AACd,CAAC,AAED,EAAE,eAAC,CAAC,AACF,OAAO,CAAE,CAAC,CAAC,IAAI,AACjB,CAAC,AAED,SAAS,eAAC,CAAC,AACT,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,aAAa,CAAE,OAAO,CACnB,UAAU,CAAE,OAAO,CACtB,kBAAkB,CAAE,MAAM,CACvB,eAAe,CAAE,MAAM,CAC1B,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,OAAO,CACzB,aAAa,CAAE,GAAG,CAClB,YAAY,CAAE,IAAI,CAClB,OAAO,CAAE,GAAG,AACd,CAAC,AAED,OAAO,eAAC,CAAC,AACP,UAAU,CAAE,GAAG,CAAC,KAAK,CAAC,OAAO,AAC/B,CAAC,AACD,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACzB,OAAO,eAAC,CAAC,AACP,aAAa,CAAE,IAAI,CACnB,WAAW,CAAE,IAAI,AACnB,CAAC,AACH,CAAC,AAED,YAAY,eAAC,CAAC,AACZ,OAAO,CAAE,IAAI,AACf,CAAC,AAED,KAAK,eAAC,CAAC,AACL,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,AACd,CAAC,AAED,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACzB,aAAa,eAAC,CAAC,AACb,OAAO,CAAE,IAAI,AACf,CAAC,AAED,YAAY,eAAC,CAAC,AACZ,OAAO,CAAE,OAAO,AAClB,CAAC,AACH,CAAC"}'
};
var Nav = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_page();
  return `<nav class="${"row jbetween acenter xfill svelte-1nrfjse"}"><a href="${"/"}"><img class="${"logo svelte-1nrfjse"}" src="${"/logo.svg"}" alt="${"facturasgratis"}"></a>

  <ul class="${"desktop-menu row yfill svelte-1nrfjse"}">${each(routes, (route) => `<li class="${["row acenter yfill svelte-1nrfjse", $page.path === route.slug ? "active" : ""].join(" ").trim()}"><a${add_attribute("href", route.slug, 0)} class="${"row acenter yfill"}">${route.title === $userData.legal_name && $userData.logo ? `<img class="${"user-img svelte-1nrfjse"}"${add_attribute("src", $userData.logo, 0)}${add_attribute("alt", $userData.legal_name || "Logotipo", 0)}>` : ``}

          ${escape(route.title)}</a>
      </li>`)}</ul>

  <a class="${"mobile-menu row fcenter svelte-1nrfjse"}" href="${"/ajustes"}">${$userData.logo ? `<img class="${"user-img svelte-1nrfjse"}"${add_attribute("src", $userData.logo, 0)}${add_attribute("alt", $userData.legal_name || "Logotipo", 0)}>` : `<div class="${"icon row fcenter svelte-1nrfjse"}"><img class="${"fill"}" src="${"/options.svg"}" alt="${"Men\xFA"}"></div>`}</a>
</nav>`;
});
var css$4 = {
...
<div class="${"scroll"}"><section class="${"header col fcenter xfill svelte-19j05on"}"><h1 class="${"svelte-19j05on"}">${escape(tools[0].title)}</h1>
    <p class="${"svelte-19j05on"}">${escape(tools[0].desc)}</p></section>

  ${$userData.legal_name !== void 0 ? `<div class="${"list-filter col acenter xfill svelte-19j05on"}">${$bills.length <= 0 ? `<a class="${"btn succ semi"}" href="${"/facturas/nueva"}">CREA TU PRIMERA FACTURA</a>` : `<a class="${"new-btn btn succ semi svelte-19j05on"}" href="${"/facturas/nueva"}">NUEVA FACTURA</a>

        <div class="${"row xfill"}"><input type="${"text"}" class="${"out grow"}" placeholder="${"Buscar factura"}"${add_attribute("value", searchTerm, 0)}>

          <select class="${"out svelte-19j05on"}"><option value="${""}">Todos los meses</option>${each(months, (month, i) => `<option${add_attribute("value", i, 0)}>${escape(month)}</option>`)}</select>

          <select class="${"out svelte-19j05on"}"><option value="${""}">Todos los a\xF1os</option>${each(years(), (year, i) => `<option${add_attribute("value", i, 0)}>${escape(year)}</option>`)}</select></div>`}</div>

    <ul class="${"bill-list col acenter xfill svelte-19j05on"}">${each($bills, (bill) => `<li class="${"box round row jbetween xfill"}">${escape(bill.client.legal_name)} <span>${escape(bill.number)}</span></li>`)}</ul>` : `<div class="${"first col acenter xfill svelte-19j05on"}"><h2>Primeros pasos</h2>
      <p>Para poder empezar a generar facturas, primero tienes que rellenar tus datos</p>
      <br>
      <a href="${"/ajustes"}" class="${"btn pri semi svelte-19j05on"}">RELLENAR DATOS</a></div>`}
</div>`;
});
...
var Nueva = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_bills();
  return `<div class="${"scroll"}"><form class="${"bill-data col acenter xfill svelte-tdfadj"}"><div class="${"box round col xfill svelte-tdfadj"}"><h2>Datos de la factura</h2>
      <p class="${"notice svelte-tdfadj"}">La numeraci\xF3n y fecha de la factura se rellenan automatiamente, pero puedes modificarlas.</p>

      <div class="${"row xfill"}"><div class="${"input-wrapper col grow svelte-tdfadj"}"><label for="${"legal_name"}" class="${"svelte-tdfadj"}">N\xFAmero</label>
          <input type="${"number"}" id="${"legal_name"}" class="${"xfill svelte-tdfadj"}" required${add_attribute("value", billData.number, 0)}></div>

        <div class="${"date-row row xhalf svelte-tdfadj"}"><div class="${"input-wrapper date col svelte-tdfadj"}"><label for="${"day"}" class="${"svelte-tdfadj"}">D\xEDa</label>
            <input type="${"number"}" id="${"day"}" class="${"xfill svelte-tdfadj"}" required${add_attribute("value", billData.date.day, 0)}></div>
          <div class="${"input-wrapper date col svelte-tdfadj"}"><label for="${"month"}" class="${"svelte-tdfadj"}">Mes</label>
            <input type="${"number"}" id="${"month"}" class="${"xfill svelte-tdfadj"}" required${add_attribute("value", billData.date.month, 0)}></div>
          <div class="${"input-wrapper date col svelte-tdfadj"}"><label for="${"year"}" class="${"svelte-tdfadj"}">A\xF1o</label>
            <input type="${"number"}" id="${"year"}" class="${"xfill svelte-tdfadj"}" required${add_attribute("value", billData.date.year, 0)}></div></div></div></div>

    <div class="${"box round col xfill svelte-tdfadj"}"><h2>Datos del cliente</h2>
      <p class="${"notice svelte-tdfadj"}">Cada vez que a\xF1adas un cliente nuevo, este se guardara automatiamente.</p>

      <div class="${"input-wrapper col xfill svelte-tdfadj"}"><label for="${"legal_name"}" class="${"svelte-tdfadj"}">NOMBRE FISCAL</label>
        <input type="${"text"}" id="${"leagal_name"}" class="${"xfill svelte-tdfadj"}" required${add_attribute("value", billData.client.legal_name, 0)}></div>

      <div class="${"input-wrapper col xfill svelte-tdfadj"}"><label for="${"legal_id"}" class="${"svelte-tdfadj"}">CIF/NIF</label>
        <input type="${"text"}" id="${"leagal_id"}" class="${"xfill svelte-tdfadj"}" required${add_attribute("value", billData.client.legal_id, 0)}></div>

      <div class="${"input-wrapper col xfill svelte-tdfadj"}"><label for="${"address"}" class="${"svelte-tdfadj"}">DIRECCION FISCAL</label>
        <input type="${"text"}" id="${"address"}" class="${"xfill svelte-tdfadj"}" required${add_attribute("value", billData.client.address, 0)}></div>

      <div class="${"input-wrapper row xfill svelte-tdfadj"}"><div class="${"col xhalf"}"><label for="${"city"}" class="${"svelte-tdfadj"}">POBLACI\xD3N</label>
          <input type="${"text"}" id="${"city"}" class="${"xfill svelte-tdfadj"}" required${add_attribute("value", billData.client.city, 0)}></div>

        <div class="${"col xhalf"}"><label for="${"cp"}" class="${"svelte-tdfadj"}">C\xF3digo postal</label>
          <input type="${"text"}" id="${"cp"}" class="${"xfill svelte-tdfadj"}" required${add_attribute("value", billData.client.cp, 0)}></div></div>

      <div class="${"input-wrapper col xfill svelte-tdfadj"}"><label for="${"country"}" class="${"svelte-tdfadj"}">Pa\xEDs</label>
        <input type="${"text"}" id="${"country"}" class="${"xfill svelte-tdfadj"}" required${add_attribute("value", billData.client.country, 0)}></div>

      <div class="${"input-wrapper col xfill svelte-tdfadj"}"><label for="${"contact"}" class="${"svelte-tdfadj"}">Conacto</label>
        <input type="${"text"}" id="${"contact"}" class="${"xfill svelte-tdfadj"}" required${add_attribute("value", billData.client.contact, 0)}></div></div>

    <div class="${"box round col xfill svelte-tdfadj"}"><h2>Conceptos</h2>
      <p class="${"notice svelte-tdfadj"}">Cada vez que a\xF1adas un producto/servicio nuevo, este se guardara automatiamente.</p>

      ${billData.items.length > 0 ? `<ul class="${"bill-items col acenter xfill"}">${each(billData.items, (item, i) => `<li class="${"line row xfill svelte-tdfadj"}"><input type="${"number"}" id="${"amount"}" min="${"1"}" class="${"out svelte-tdfadj"}" placeholder="${"CANT"}"${add_attribute("value", item.amount, 0)}>
              <input type="${"text"}" id="${"label"}" class="${"out grow svelte-tdfadj"}" placeholder="${"CONCEPTO"}"${add_attribute("value", item.label, 0)}>
              <input type="${"number"}" id="${"dto"}" min="${"0"}" max="${"100"}" class="${"out svelte-tdfadj"}" placeholder="${"DTO %"}"${add_attribute("value", item.dto, 0)}>
              <input type="${"number"}" id="${"price"}" step="${"0.01"}" class="${"out svelte-tdfadj"}" placeholder="${"UNIDAD \u20AC"}"${add_attribute("value", item.price, 0)}>
              <input type="${"text"}" value="${"x"}" class="${"out svelte-tdfadj"}">
            </li>`)}</ul>

        <h-div class="${"svelte-tdfadj"}"></h-div>` : ``}

      <div class="${"new-line row xfill"}"><input type="${"number"}" id="${"amount"}" min="${"1"}" class="${"out svelte-tdfadj"}" placeholder="${"CANT"}"${add_attribute("value", lineData.amount, 0)}>
        <input type="${"text"}" id="${"label"}" class="${"out grow svelte-tdfadj"}" placeholder="${"CONCEPTO"}"${add_attribute("value", lineData.label, 0)}>
        <input type="${"number"}" id="${"dto"}" min="${"0"}" max="${"100"}" class="${"out svelte-tdfadj"}" placeholder="${"DTO %"}"${add_attribute("value", lineData.dto, 0)}>
        <input type="${"number"}" id="${"price"}" step="${"0.01"}" class="${"out svelte-tdfadj"}" placeholder="${"UNIDAD \u20AC"}"${add_attribute("value", lineData.price, 0)}></div>

      <div class="${"line-btn pri xfill svelte-tdfadj"}">A\xD1ADIR PRODUCTO/SERVICIO</div></div>

    <button class="${"pri semi svelte-tdfadj"}">GENERAR FACTURA</button></form>
</div>`;
});
...
<div class="${"scroll"}"><section class="${"header col fcenter xfill svelte-1a0ueg1"}"><h1 class="${"svelte-1a0ueg1"}">Tus datos de facturaci\xF3n</h1>
    <p class="${"svelte-1a0ueg1"}">En <b>facturagratis</b>, no nos gusta guardar ning\xFAn dato, y menos unos tan sensibles como pueden ser los requeridos para hacer facturas. As\xED pues todos los datos introducidos aqu\xED, solo se guardaran en este navegador.
    </p></section>

  ${$userData ? `<div class="${"info col acenter xfill svelte-1a0ueg1"}"><div class="${"box round col xfill svelte-1a0ueg1"}"><h2>Logotipo</h2>
        <p class="${"notice svelte-1a0ueg1"}">Si usas logotipo en tus facturas, presupuestos o albaranes, aqui es el sitio.</p>

        <div class="${"row xfill"}"><label for="${"logo"}" class="${"file-btn svelte-1a0ueg1"}">SUBIR IM\xC1GEN</label>

          ${logo ? `<div class="${"file-btn remove-btn svelte-1a0ueg1"}">BORRAR IM\xC1GEN</div>` : ``}</div>

        <input type="${"file"}" id="${"logo"}" accept="${"image/png, image/jpeg"}" class="${"xfill svelte-1a0ueg1"}">

        ${logo ? `<div class="${"logo-wrapper row fcenter xfill svelte-1a0ueg1"}"><img${add_attribute("src", logo, 0)}${add_attribute("alt", $userData.legal_name || "Logotipo", 0)} class="${"svelte-1a0ueg1"}"></div>` : ``}</div>

      <div class="${"box round col xfill svelte-1a0ueg1"}"><h2>Datos legales</h2>
        <p class="${"notice svelte-1a0ueg1"}">Los campos marcados con un \u{1F448} son obliquos.</p>

        <div class="${"input-wrapper col xfill svelte-1a0ueg1"}"><label for="${"legal_name"}" class="${"svelte-1a0ueg1"}">Nombre fiscal \u{1F448}</label>
          <input type="${"text"}" id="${"legal_name"}" class="${"xfill svelte-1a0ueg1"}" placeholder="${"Ej. Factura Gratis S.L."}"${add_attribute("value", $userData.legal_name, 0)}></div>

        <div class="${"input-wrapper col xfill svelte-1a0ueg1"}"><label for="${"legal_id"}" class="${"svelte-1a0ueg1"}">CIF/NIF \u{1F448}</label>
          <input type="${"text"}" id="${"legal_id"}" class="${"xfill svelte-1a0ueg1"}" placeholder="${"Ej. B00011100"}"${add_attribute("value", $userData.legal_id, 0)}></div></div>

      <div class="${"box round col xfill svelte-1a0ueg1"}"><h2>Direcci\xF3n fiscal</h2>
        <p class="${"notice svelte-1a0ueg1"}">Los campos marcados con un \u{1F448} son obliquos.</p>

        <div class="${"input-wrapper col xfill svelte-1a0ueg1"}"><label for="${"street"}" class="${"svelte-1a0ueg1"}">Direcci\xF3n fiscal \u{1F448}</label>
          <input type="${"text"}" id="${"street"}" class="${"xfill svelte-1a0ueg1"}" placeholder="${"Ej. Calle Mayor, 18"}"${add_attribute("value", $userData.street, 0)}></div>

        <div class="${"row xfill"}"><div class="${"input-wrapper col xhalf svelte-1a0ueg1"}"><label for="${"city"}" class="${"svelte-1a0ueg1"}">Poblaci\xF3n \u{1F448}</label>
            <input type="${"text"}" id="${"city"}" class="${"xfill svelte-1a0ueg1"}" placeholder="${"Ej. Barcelona"}"${add_attribute("value", $userData.city, 0)}></div>

          <div class="${"input-wrapper col xhalf svelte-1a0ueg1"}"><label for="${"cp"}" class="${"svelte-1a0ueg1"}">C\xF3digo postal \u{1F448}</label>
            <input type="${"text"}" id="${"cp"}" class="${"xfill svelte-1a0ueg1"}" placeholder="${"Ej. 08818"}"${add_attribute("value", $userData.cp, 0)}></div></div>

        <div class="${"input-wrapper col xfill svelte-1a0ueg1"}"><label for="${"country"}" class="${"svelte-1a0ueg1"}">Pa\xEDs \u{1F448}</label>
          <input type="${"text"}" id="${"country"}" class="${"xfill svelte-1a0ueg1"}" placeholder="${"Ej. Espa\xF1a"}"${add_attribute("value", $userData.country, 0)}></div></div>

      <div class="${"box round col xfill svelte-1a0ueg1"}"><h2>Contacto</h2>
        <p class="${"notice svelte-1a0ueg1"}">Puedes rellenar ambos campos, pero con uno es suficiente</p>

        <div class="${"input-wrapper col xfill svelte-1a0ueg1"}"><label for="${"phone"}" class="${"svelte-1a0ueg1"}">Tel\xE9fono</label>
          <input type="${"text"}" id="${"phone"}" class="${"xfill svelte-1a0ueg1"}" placeholder="${"Ej. 600 600 600"}"${add_attribute("value", $userData.phone, 0)}></div>

        <div class="${"input-wrapper col xfill svelte-1a0ueg1"}"><label for="${"email"}" class="${"svelte-1a0ueg1"}">Correo electr\xF3nico</label>
          <input type="${"text"}" id="${"email"}" class="${"xfill svelte-1a0ueg1"}" placeholder="${"Ej. hola@facturagratis.com"}"${add_attribute("value", $userData.email, 0)}></div></div>

      <div class="${"box round col xfill svelte-1a0ueg1"}"><h2>Impuestos</h2>
        <p class="${"notice svelte-1a0ueg1"}">Selecciona el tipo de IVA y retenci\xF3n. Si no rellenas el campo de la retenci\xF3n, no la aplicaremos.</p>

        <div class="${"input-wrapper col xfill svelte-1a0ueg1"}"><label for="${"iva"}" class="${"svelte-1a0ueg1"}">IVA</label>
          <select id="${"iva"}" class="${"xfill svelte-1a0ueg1"}"><option value="${"21"}">21%</option><option value="${"10"}">10%</option><option value="${"4"}">4%</option></select></div>

        <div class="${"input-wrapper col xfill svelte-1a0ueg1"}"><label for="${"ret"}" class="${"svelte-1a0ueg1"}">Retenci\xF3n (%)</label>
          <input type="${"number"}" id="${"ret"}" class="${"xfill svelte-1a0ueg1"}" placeholder="${"Ej. 15"}"${add_attribute("value", $userData.ret, 0)}></div></div></div>` : ``}
</div>`;
});
