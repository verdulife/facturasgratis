...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-28d6b71d.js",
      css: [assets + "/_app/assets/start-c446e5f0.css", assets + "/_app/assets/vendor-430b14cd.css"],
      js: [assets + "/_app/start-28d6b71d.js", assets + "/_app/chunks/vendor-2d80ca99.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-acda0bd8.js", "css": ["assets/pages/__layout.svelte-0c6b0ff6.css", "assets/vendor-430b14cd.css"], "js": ["pages/__layout.svelte-acda0bd8.js", "chunks/vendor-2d80ca99.js", "chunks/stores-b18daa98.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-50ace51c.js", "css": ["assets/vendor-430b14cd.css"], "js": ["error.svelte-50ace51c.js", "chunks/vendor-2d80ca99.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-8677957e.js", "css": ["assets/pages/index.svelte-f528a31d.css", "assets/vendor-430b14cd.css"], "js": ["pages/index.svelte-8677957e.js", "chunks/vendor-2d80ca99.js"], "styles": [] }, "src/routes/ajustes/index.svelte": { "entry": "pages/ajustes/index.svelte-2609536b.js", "css": ["assets/pages/ajustes/index.svelte-119204fe.css", "assets/vendor-430b14cd.css"], "js": ["pages/ajustes/index.svelte-2609536b.js", "chunks/vendor-2d80ca99.js", "chunks/stores-b18daa98.js"], "styles": [] } };
...
<div class="${"scroll"}"><section class="${"header col fcenter xfill svelte-agjaa5"}"><h1 class="${"svelte-agjaa5"}">Tus datos de facturaci\xF3n</h1>
    <p class="${"svelte-agjaa5"}">En <b>facturagratis</b>, no nos gusta guardar ning\xFAn dato, y menos unos tan sensibles como pueden ser los
      requeridos para hacer facturas. As\xED pues todos los datos introducidos aqu\xED, solo se guardaran en este navegador.
    </p></section>

  ${$userData ? `<div class="${"info col acenter xfill svelte-agjaa5"}">
      ...
      <div class="${"box round col xfill svelte-agjaa5"}"><h2>Datos legales</h2>
        <p class="${"notice svelte-agjaa5"}">Los campos marcados con un \u{1F448} son obliquos.</p>

        <div class="${"input-wrapper col xfill svelte-agjaa5"}"><label for="${"legal_name"}" class="${"svelte-agjaa5"}">Nombre fiscal \u{1F448}</label>
          <input type="${"text"}" id="${"legal_name"}" class="${"xfill svelte-agjaa5"}" placeholder="${"Ej. Factura Gratis S.L."}" required${add_attribute("value", $userData.legal_name, 0)}></div>

        <div class="${"input-wrapper col xfill svelte-agjaa5"}"><label for="${"legal_id"}" class="${"svelte-agjaa5"}">CIF/NIF \u{1F448}</label>
          <input type="${"text"}" id="${"legal_id"}" class="${"xfill svelte-agjaa5"}" placeholder="${"Ej. B00011100"}" required${add_attribute("value", $userData.legal_id, 0)}></div></div>

      <div class="${"box round col xfill svelte-agjaa5"}"><h2>Direcci\xF3n fiscal</h2>
        <p class="${"notice svelte-agjaa5"}">Los campos marcados con un \u{1F448} son obliquos.</p>

        <div class="${"input-wrapper col xfill svelte-agjaa5"}"><label for="${"street_kind"}" class="${"svelte-agjaa5"}">Tipo de via \u{1F448}</label>
          <input type="${"text"}" id="${"street_kind"}" class="${"xfill svelte-agjaa5"}" placeholder="${"Ej. Calle"}" required${add_attribute("value", $userData.street_kind, 0)}></div>

        <div class="${"input-wrapper col xfill svelte-agjaa5"}"><label for="${"street_name"}" class="${"svelte-agjaa5"}">Nombre de la via \u{1F448}</label>
          <input type="${"text"}" id="${"street_name"}" class="${"xfill svelte-agjaa5"}" placeholder="${"Ej. Mayor"}" required${add_attribute("value", $userData.street_name, 0)}></div>

        <div class="${"input-wrapper col xfill svelte-agjaa5"}"><label for="${"street_number"}" class="${"svelte-agjaa5"}">N\xFAmero \u{1F448}</label>
          <input type="${"text"}" id="${"street_number"}" class="${"xfill svelte-agjaa5"}" placeholder="${"Ej. 16"}" required${add_attribute("value", $userData.street_number, 0)}></div>

        <div class="${"input-wrapper col xfill svelte-agjaa5"}"><label for="${"cp"}" class="${"svelte-agjaa5"}">C\xF3digo postal \u{1F448}</label>
          <input type="${"text"}" id="${"cp"}" class="${"xfill svelte-agjaa5"}" placeholder="${"Ej. 08818"}" required${add_attribute("value", $userData.cp, 0)}></div>

        <div class="${"input-wrapper col xfill svelte-agjaa5"}"><label for="${"city"}" class="${"svelte-agjaa5"}">Poblaci\xF3n \u{1F448}</label>
          <input type="${"text"}" id="${"city"}" class="${"xfill svelte-agjaa5"}" placeholder="${"Ej. Barcelona"}" required${add_attribute("value", $userData.city, 0)}></div>

        <div class="${"input-wrapper col xfill svelte-agjaa5"}"><label for="${"country"}" class="${"svelte-agjaa5"}">Pa\xEDs \u{1F448}</label>
          <input type="${"text"}" id="${"country"}" class="${"xfill svelte-agjaa5"}" placeholder="${"Ej. Espa\xF1a"}" required${add_attribute("value", $userData.country, 0)}></div></div>

      <div class="${"box round col xfill svelte-agjaa5"}"><h2>Contacto</h2>
        <p class="${"notice svelte-agjaa5"}">Puedes rellenar ambos campos, pero con uno es suficiente</p>

        <div class="${"input-wrapper col xfill svelte-agjaa5"}"><label for="${"phone"}" class="${"svelte-agjaa5"}">Tel\xE9fono</label>
          <input type="${"text"}" id="${"phone"}" class="${"xfill svelte-agjaa5"}" placeholder="${"Ej. 600 600 600"}" required${add_attribute("value", $userData.phone, 0)}></div>

        <div class="${"input-wrapper col xfill svelte-agjaa5"}"><label for="${"email"}" class="${"svelte-agjaa5"}">Correo electr\xF3nico</label>
          <input type="${"text"}" id="${"email"}" class="${"xfill svelte-agjaa5"}" placeholder="${"Ej. hola@facturagratis.com"}" required${add_attribute("value", $userData.email, 0)}></div></div>

      <div class="${"box round col xfill svelte-agjaa5"}"><h2>Impuestos</h2>
        <p class="${"notice svelte-agjaa5"}">Selecciona el tipo de IVA y retenci\xF3n. Si no rellenas el campo de la retenci\xF3n, no la aplicaremos.
        </p>

        <div class="${"input-wrapper col xfill svelte-agjaa5"}"><label for="${"iva"}" class="${"svelte-agjaa5"}">IVA</label>
          <select id="${"iva"}" class="${"xfill svelte-agjaa5"}" required><option value="${"21"}">21%</option><option value="${"10"}">10%</option><option value="${"4"}">4%</option></select></div>

        <div class="${"input-wrapper col xfill svelte-agjaa5"}"><label for="${"ret"}" class="${"svelte-agjaa5"}">Retenci\xF3n (%)</label>
          <input type="${"number"}" id="${"ret"}" class="${"xfill svelte-agjaa5"}" placeholder="${"Ej. 15"}" required${add_attribute("value", $userData.ret, 0)}></div></div></div>` : ``}
</div>`;
});
