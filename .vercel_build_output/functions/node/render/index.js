...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-d4798c73.js",
      css: [assets + "/_app/assets/start-c446e5f0.css"],
      js: [assets + "/_app/start-d4798c73.js", assets + "/_app/chunks/vendor-dc9a6933.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-c59ac168.js", "css": ["assets/pages/__layout.svelte-0c6b0ff6.css"], "js": ["pages/__layout.svelte-c59ac168.js", "chunks/vendor-dc9a6933.js", "chunks/stores-1b0eb97a.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-ba6df313.js", "css": [], "js": ["error.svelte-ba6df313.js", "chunks/vendor-dc9a6933.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-7381ae26.js", "css": ["assets/pages/index.svelte-f528a31d.css"], "js": ["pages/index.svelte-7381ae26.js", "chunks/vendor-dc9a6933.js"], "styles": [] }, "src/routes/ajustes/index.svelte": { "entry": "pages/ajustes/index.svelte-664899ca.js", "css": ["assets/pages/ajustes/index.svelte-060592db.css"], "js": ["pages/ajustes/index.svelte-664899ca.js", "chunks/vendor-dc9a6933.js", "chunks/stores-1b0eb97a.js"], "styles": [] } };
...
<div class="${"scroll"}"><section class="${"header col fcenter xfill svelte-n3pn2k"}"><h1 class="${"svelte-n3pn2k"}">Tus datos de facturaci\xF3n</h1>
    <p class="${"svelte-n3pn2k"}">En <b>facturagratis</b>, no nos gusta guardar ning\xFAn dato, y menos unos tan sensibles como pueden ser los
      requeridos para hacer facturas. As\xED pues todos los datos introducidos aqu\xED, solo se guardaran en este navegador.
    </p></section>

  ${$userData ? `<div class="${"info col acenter xfill svelte-n3pn2k"}"><div class="${"box round col xfill svelte-n3pn2k"}"><h2>Logotipo</h2>
        <p class="${"notice svelte-n3pn2k"}">Si usas logotipo en tus facturas, presupuestos o albaranes, aqui es el sitio.</p>

        <input type="${"file"}" class="${"svelte-n3pn2k"}"></div>

      <div class="${"box round col xfill svelte-n3pn2k"}"><h2>Datos legales</h2>
        <p class="${"notice svelte-n3pn2k"}">Los campos marcados con un \u{1F448} son obliquos.</p>

        <div class="${"input-wrapper col xfill svelte-n3pn2k"}"><label for="${"legal_name"}" class="${"svelte-n3pn2k"}">Nombre fiscal \u{1F448}</label>
          <input type="${"text"}" id="${"legal_name"}" class="${"xfill svelte-n3pn2k"}" placeholder="${"Ej. Factura Gratis S.L."}" required${add_attribute("value", $userData.legal_name, 0)}></div>

        <div class="${"input-wrapper col xfill svelte-n3pn2k"}"><label for="${"legal_id"}" class="${"svelte-n3pn2k"}">CIF/NIF \u{1F448}</label>
          <input type="${"text"}" id="${"legal_id"}" class="${"xfill svelte-n3pn2k"}" placeholder="${"Ej. B00011100"}" required${add_attribute("value", $userData.legal_id, 0)}></div></div>

      <div class="${"box round col xfill svelte-n3pn2k"}"><h2>Direcci\xF3n fiscal</h2>
        <p class="${"notice svelte-n3pn2k"}">Los campos marcados con un \u{1F448} son obliquos.</p>

        <div class="${"input-wrapper col xfill svelte-n3pn2k"}"><label for="${"street_kind"}" class="${"svelte-n3pn2k"}">Tipo de via \u{1F448}</label>
          <input type="${"text"}" id="${"street_kind"}" class="${"xfill svelte-n3pn2k"}" placeholder="${"Ej. Calle"}" required${add_attribute("value", $userData.street_kind, 0)}></div>

        <div class="${"input-wrapper col xfill svelte-n3pn2k"}"><label for="${"street_name"}" class="${"svelte-n3pn2k"}">Nombre de la via \u{1F448}</label>
          <input type="${"text"}" id="${"street_name"}" class="${"xfill svelte-n3pn2k"}" placeholder="${"Ej. Mayor"}" required${add_attribute("value", $userData.street_name, 0)}></div>

        <div class="${"input-wrapper col xfill svelte-n3pn2k"}"><label for="${"street_number"}" class="${"svelte-n3pn2k"}">N\xFAmero \u{1F448}</label>
          <input type="${"text"}" id="${"street_number"}" class="${"xfill svelte-n3pn2k"}" placeholder="${"Ej. 16"}" required${add_attribute("value", $userData.street_number, 0)}></div>

        <div class="${"input-wrapper col xfill svelte-n3pn2k"}"><label for="${"cp"}" class="${"svelte-n3pn2k"}">C\xF3digo postal \u{1F448}</label>
          <input type="${"text"}" id="${"cp"}" class="${"xfill svelte-n3pn2k"}" placeholder="${"Ej. 08818"}" required${add_attribute("value", $userData.cp, 0)}></div>

        <div class="${"input-wrapper col xfill svelte-n3pn2k"}"><label for="${"city"}" class="${"svelte-n3pn2k"}">Poblaci\xF3n \u{1F448}</label>
          <input type="${"text"}" id="${"city"}" class="${"xfill svelte-n3pn2k"}" placeholder="${"Ej. Barcelona"}" required${add_attribute("value", $userData.city, 0)}></div>

        <div class="${"input-wrapper col xfill svelte-n3pn2k"}"><label for="${"country"}" class="${"svelte-n3pn2k"}">Pa\xEDs \u{1F448}</label>
          <input type="${"text"}" id="${"country"}" class="${"xfill svelte-n3pn2k"}" placeholder="${"Ej. Espa\xF1a"}" required${add_attribute("value", $userData.country, 0)}></div></div>

      <div class="${"box round col xfill svelte-n3pn2k"}"><h2>Contacto</h2>
        <p class="${"notice svelte-n3pn2k"}">Puedes rellenar ambos campos, pero con uno es suficiente</p>

        <div class="${"input-wrapper col xfill svelte-n3pn2k"}"><label for="${"phone"}" class="${"svelte-n3pn2k"}">Tel\xE9fono</label>
          <input type="${"text"}" id="${"phone"}" class="${"xfill svelte-n3pn2k"}" placeholder="${"Ej. 600 600 600"}" required${add_attribute("value", $userData.phone, 0)}></div>

        <div class="${"input-wrapper col xfill svelte-n3pn2k"}"><label for="${"email"}" class="${"svelte-n3pn2k"}">Correo electr\xF3nico</label>
          <input type="${"text"}" id="${"email"}" class="${"xfill svelte-n3pn2k"}" placeholder="${"Ej. hola@facturagratis.com"}" required${add_attribute("value", $userData.email, 0)}></div></div>

      <div class="${"box round col xfill svelte-n3pn2k"}"><h2>Impuestos</h2>
        <p class="${"notice svelte-n3pn2k"}">Selecciona el tipo de IVA y retenci\xF3n. Si no rellenas el campo de la retenci\xF3n, no la aplicaremos.
        </p>

        <div class="${"input-wrapper col xfill svelte-n3pn2k"}"><label for="${"iva"}" class="${"svelte-n3pn2k"}">IVA</label>
          <select id="${"iva"}" class="${"xfill svelte-n3pn2k"}" required><option value="${"21"}">21%</option><option value="${"10"}">10%</option><option value="${"4"}">4%</option></select></div>

        <div class="${"input-wrapper col xfill svelte-n3pn2k"}"><label for="${"ret"}" class="${"svelte-n3pn2k"}">Retenci\xF3n (%)</label>
          <input type="${"number"}" id="${"ret"}" class="${"xfill svelte-n3pn2k"}" placeholder="${"Ej. 15"}" required${add_attribute("value", $userData.ret, 0)}></div></div></div>` : ``}
</div>`;
});
