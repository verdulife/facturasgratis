...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-f5387cbe.js",
      css: [assets + "/_app/assets/start-c446e5f0.css"],
      js: [assets + "/_app/start-f5387cbe.js", assets + "/_app/chunks/vendor-0999ec80.js", assets + "/_app/chunks/singletons-12a22614.js"]
    },
    fetched: void 0,
    floc: false,
...
var empty = () => ({});
var manifest = {
  assets: [{ "file": "albaranes.svg", "size": 4441, "type": "image/svg+xml" }, { "file": "clientes.svg", "size": 7548, "type": "image/svg+xml" }, { "file": "delete.svg", "size": 718, "type": "image/svg+xml" }, { "file": "facturas.svg", "size": 5608, "type": "image/svg+xml" }, { "file": "favicon.png", "size": 856, "type": "image/png" }, { "file": "imago.svg", "size": 1117, "type": "image/svg+xml" }, { "file": "logo-192.png", "size": 2908, "type": "image/png" }, { "file": "logo-512.png", "size": 4325, "type": "image/png" }, { "file": "logo-h.svg", "size": 8404, "type": "image/svg+xml" }, { "file": "logo-s.svg", "size": 7315, "type": "image/svg+xml" }, { "file": "logo-v.svg", "size": 8367, "type": "image/svg+xml" }, { "file": "logo.svg", "size": 8028, "type": "image/svg+xml" }, { "file": "menu.svg", "size": 600, "type": "image/svg+xml" }, { "file": "mobile.png", "size": 3074, "type": "image/png" }, { "file": "options.svg", "size": 2065, "type": "image/svg+xml" }, { "file": "presupuestos.svg", "size": 24316, "type": "image/svg+xml" }, { "file": "productos-servicios.svg", "size": 18311, "type": "image/svg+xml" }, { "file": "proveedores.svg", "size": 13413, "type": "image/svg+xml" }, { "file": "robots.txt", "size": 67, "type": "text/plain" }],
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-07dadc10.js", "css": ["assets/pages/__layout.svelte-95eec431.css"], "js": ["pages/__layout.svelte-07dadc10.js", "chunks/vendor-0999ec80.js", "chunks/stores-36eb6521.js", "chunks/stores-5ee9f122.js", "chunks/utils-5b61615d.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-42205f1f.js", "css": [], "js": ["error.svelte-42205f1f.js", "chunks/vendor-0999ec80.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-08e4235a.js", "css": ["assets/pages/index.svelte-e9dc129a.css"], "js": ["pages/index.svelte-08e4235a.js", "chunks/vendor-0999ec80.js", "chunks/utils-5b61615d.js"], "styles": [] }, "src/routes/facturas/index.svelte": { "entry": "pages/facturas/index.svelte-2a04eeb3.js", "css": ["assets/pages/facturas/index.svelte-3415a2f1.css"], "js": ["pages/facturas/index.svelte-2a04eeb3.js", "chunks/vendor-0999ec80.js", "chunks/stores-5ee9f122.js", "chunks/utils-5b61615d.js"], "styles": [] }, "src/routes/facturas/nueva.svelte": { "entry": "pages/facturas/nueva.svelte-498db3d0.js", "css": ["assets/pages/facturas/[id].svelte-6b726292.css"], "js": ["pages/facturas/nueva.svelte-498db3d0.js", "chunks/vendor-0999ec80.js", "chunks/navigation-51f4a605.js", "chunks/singletons-12a22614.js", "chunks/stores-5ee9f122.js"], "styles": [] }, "src/routes/facturas/[id].svelte": { "entry": "pages/facturas/[id].svelte-af0d543c.js", "css": ["assets/pages/facturas/[id].svelte-6b726292.css"], "js": ["pages/facturas/[id].svelte-af0d543c.js", "chunks/vendor-0999ec80.js", "chunks/stores-36eb6521.js", "chunks/navigation-51f4a605.js", "chunks/singletons-12a22614.js", "chunks/stores-5ee9f122.js"], "styles": [] }, "src/routes/ajustes/index.svelte": { "entry": "pages/ajustes/index.svelte-dd4b4277.js", "css": ["assets/pages/ajustes/index.svelte-c8f714b9.css"], "js": ["pages/ajustes/index.svelte-dd4b4277.js", "chunks/vendor-0999ec80.js", "chunks/navigation-51f4a605.js", "chunks/singletons-12a22614.js", "chunks/stores-5ee9f122.js"], "styles": [] } };
...
var Nav = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<nav class="${"row jbetween acenter xfill svelte-z2v7v2"}"><a href="${"/"}" class="${"row acenter"}"><img class="${"logo svelte-z2v7v2"}" src="${"/logo.svg"}" alt="${"facturasgratis"}"></a>

  <ul class="${"desktop-menu row yfill svelte-z2v7v2"}"><li class="${"row acenter yfill svelte-z2v7v2"}"><a href="${"/"}" class="${"row acenter yfill"}">Herramientas</a>

      <ul class="${"expand-menu col svelte-z2v7v2"}">${each(tools, ({ slug, title, icon }) => `<li class="${["xfill svelte-z2v7v2", $page.path === slug ? "active" : ""].join(" ").trim()}"><a${add_attribute("href", slug, 0)} class="${"row nowrap acenter fill"}"><img${add_attribute("src", icon, 0)}${add_attribute("alt", title, 0)} class="${"svelte-z2v7v2"}">
              <p>${escape(title)}</p></a>
          </li>`)}</ul></li>

    <li class="${"row acenter yfill svelte-z2v7v2"}"><a href="${"/ajustes"}" class="${"row acenter yfill"}">${$userData.logo ? `<img class="${"user-img svelte-z2v7v2"}"${add_attribute("src", $userData.logo, 0)}${add_attribute("alt", $userData.legal_name || "Logotipo", 0)}>` : ``}
        ${escape($userData.legal_name || "Ajustes")}</a></li></ul>

  <div class="${"mobile-menu row yfill svelte-z2v7v2"}"><div class="${"icon svelte-z2v7v2"}"><img class="${"fill svelte-z2v7v2"}" src="${"menu.svg"}" alt="${"Men\xFA"}"></div>
    ${``}</div>
</nav>`;
});
var css$5 = {
...
<div class="${"scroll"}"><section class="${"header col fcenter xfill svelte-12bnxg1"}"><h1 class="${"svelte-12bnxg1"}">${escape(tools[0].title)}</h1>
  ...
  ${$userData.legal_name !== void 0 ? `<div class="${"list-filter col acenter xfill svelte-12bnxg1"}">${$bills.length <= 0 ? `<a class="${"btn succ semi"}" href="${"/facturas/nueva"}">CREA TU PRIMERA FACTURA</a>` : `<a class="${"new-btn btn succ semi svelte-12bnxg1"}" href="${"/facturas/nueva"}">NUEVA FACTURA</a>
    ...
    <ul class="${"bill-list col acenter xfill svelte-12bnxg1"}">${each($bills, (bill) => `<li class="${"box round row xfill"}"><a href="${"/facturas/" + escape(bill._id)}" class="${"row jbetween xfill"}">${escape(bill.client.legal_name)} <span>${escape(bill.number)}</span></a>
        </li>`)}</ul>` : `<div class="${"first col acenter xfill svelte-12bnxg1"}"><h2>Primeros pasos</h2>
      <p>Para poder empezar a generar facturas, primero tienes que rellenar tus datos</p>
      <br>
...
var U5Bidu5D = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_userData();
  $$unsubscribe_page();
  return `<div class="${"scroll"}">${billData ? `<form class="${"bill-data col acenter xfill svelte-689xub"}"><div class="${"box round col xfill svelte-689xub"}"><h2>Datos de la factura</h2>
        <p class="${"notice svelte-689xub"}">La numeraci\xF3n y fecha de la factura se rellenan automatiamente, pero puedes modificarlas.</p>
      ...
      <div class="${"row jcenter xfill"}"><button class="${"succ semi svelte-689xub"}">GUARDAR CAMBIOS</button>
        <a href="${"/facturas"}" class="${"btn out semi svelte-689xub"}">CANCELAR</a></div></form>` : ``}
</div>`;
});
...
<div class="${"scroll"}"><section class="${"header col fcenter xfill svelte-1mh7dhf"}"><h1 class="${"svelte-1mh7dhf"}">Tus datos de facturaci\xF3n</h1>
    <p class="${"svelte-1mh7dhf"}">En <b>facturagratis</b>, usamos tu navegador como disco, asi tu
      informacion es solo tuya.
      <br>
      Por eso mismo, te recomendamos que descargues tus datos anualmente y empieces
      limpio el a\xF1o. Siempre podras volver a cargar tus datos para acceder a ellos.
    ...
    <div class="${"progress-bar col svelte-1mh7dhf"}"><div class="${"bar svelte-1mh7dhf"}" style="${"width: " + escape(storageSpace.percentage) + "%"}"></div></div>

    ${`<p class="${"svelte-1mh7dhf"}">Calculando...</p>`}
  ...
  ${user ? `<form class="${"info col acenter xfill svelte-1mh7dhf"}"><div class="${"box round col xfill svelte-1mh7dhf"}"><h2>Logotipo</h2>
        <p class="${"notice svelte-1mh7dhf"}">Si usas logotipo en tus facturas, presupuestos o albaranes, aqui es el
          sitio.
        </p>

        <div class="${"row xfill"}"><label for="${"logo"}" class="${"file-btn svelte-1mh7dhf"}">SUBIR IM\xC1GEN</label>

          ${user.logo ? `<div class="${"file-btn remove-btn svelte-1mh7dhf"}">BORRAR IM\xC1GEN
            </div>` : ``}</div>
      ...
      <div class="${"box round col xfill svelte-1mh7dhf"}"><h2>Contacto</h2>
        <p class="${"notice svelte-1mh7dhf"}">Puedes rellenar ambos campos, pero con uno es suficiente.
        </p>
      ...
      <div class="${"box round col xfill svelte-1mh7dhf"}"><h2>Moneda e impuestos</h2>
        <p class="${"notice svelte-1mh7dhf"}">Si no rellenas el campo del IRPF, no lo aplicaremos.
        </p>
      ...
      <div class="${"box round col xfill svelte-1mh7dhf"}"><h2>Notas</h2>
        <p class="${"notice svelte-1mh7dhf"}">A\xF1ade notas a pie de tus facturas, presupuestos o albaranes.
        </p>
