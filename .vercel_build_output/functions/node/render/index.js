...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-7f9124fa.js",
      css: [assets + "/_app/assets/start-c446e5f0.css"],
      js: [assets + "/_app/start-7f9124fa.js", assets + "/_app/chunks/vendor-299282bd.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-da87e4ca.js", "css": ["assets/pages/__layout.svelte-ba8838fe.css"], "js": ["pages/__layout.svelte-da87e4ca.js", "chunks/vendor-299282bd.js", "chunks/stores-ff97c658.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-e4e802a3.js", "css": [], "js": ["error.svelte-e4e802a3.js", "chunks/vendor-299282bd.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-68b36aaa.js", "css": ["assets/pages/index.svelte-f528a31d.css"], "js": ["pages/index.svelte-68b36aaa.js", "chunks/vendor-299282bd.js"], "styles": [] }, "src/routes/ajustes/index.svelte": { "entry": "pages/ajustes/index.svelte-407818e2.js", "css": ["assets/pages/ajustes/index.svelte-9cd52aa3.css"], "js": ["pages/ajustes/index.svelte-407818e2.js", "chunks/vendor-299282bd.js", "chunks/stores-ff97c658.js"], "styles": [] } };
...
<div class="${"scroll"}"><section class="${"header col fcenter xfill svelte-yduzbi"}"><h1 class="${"svelte-yduzbi"}">Tus datos de facturaci\xF3n</h1>
    <p class="${"svelte-yduzbi"}">En <b>facturagratis</b>, no nos gusta guardar ning\xFAn dato, y menos unos tan sensibles como pueden ser los
      requeridos para hacer facturas. As\xED pues todos los datos introducidos aqu\xED, solo se guardaran en este navegador.
    </p></section>

  ${$userData ? `<div class="${"info col acenter xfill svelte-yduzbi"}"><div class="${"box round col xfill svelte-yduzbi"}"><h2>Logotipo</h2>
        <p class="${"notice svelte-yduzbi"}">Si usas logotipo en tus facturas, presupuestos o albaranes, aqui es el sitio.</p>

        <div class="${"row xfill"}"><label for="${"logo"}" class="${"file-btn svelte-yduzbi"}">SUBIR IM\xC1GEN</label>

          ${logo ? `<div class="${"file-btn remove-btn svelte-yduzbi"}">BORRAR IM\xC1GEN</div>` : ``}</div>

        <input type="${"file"}" id="${"logo"}" accept="${"image/png, image/jpeg"}" class="${"xfill svelte-yduzbi"}">

        ${logo ? `<div class="${"logo-wrapper row fcenter xfill svelte-yduzbi"}"><img${add_attribute("src", logo, 0)}${add_attribute("alt", $userData.legal_name || "Logotipo", 0)} class="${"svelte-yduzbi"}"></div>` : ``}</div>

      <div class="${"box round col xfill svelte-yduzbi"}"><h2>Datos legales</h2>
        <p class="${"notice svelte-yduzbi"}">Los campos marcados con un \u{1F448} son obliquos.</p>

        <div class="${"input-wrapper col xfill svelte-yduzbi"}"><label for="${"legal_name"}" class="${"svelte-yduzbi"}">Nombre fiscal \u{1F448}</label>
          <input type="${"text"}" id="${"legal_name"}" class="${"xfill svelte-yduzbi"}" placeholder="${"Ej. Factura Gratis S.L."}" required${add_attribute("value", $userData.legal_name, 0)}></div>

        <div class="${"input-wrapper col xfill svelte-yduzbi"}"><label for="${"legal_id"}" class="${"svelte-yduzbi"}">CIF/NIF \u{1F448}</label>
          <input type="${"text"}" id="${"legal_id"}" class="${"xfill svelte-yduzbi"}" placeholder="${"Ej. B00011100"}" required${add_attribute("value", $userData.legal_id, 0)}></div></div>

      <div class="${"box round col xfill svelte-yduzbi"}"><h2>Direcci\xF3n fiscal</h2>
        <p class="${"notice svelte-yduzbi"}">Los campos marcados con un \u{1F448} son obliquos.</p>

        <div class="${"input-wrapper col xfill svelte-yduzbi"}"><label for="${"street_kind"}" class="${"svelte-yduzbi"}">Tipo de via \u{1F448}</label>
          <input type="${"text"}" id="${"street_kind"}" class="${"xfill svelte-yduzbi"}" placeholder="${"Ej. Calle"}" required${add_attribute("value", $userData.street_kind, 0)}></div>

        <div class="${"input-wrapper col xfill svelte-yduzbi"}"><label for="${"street_name"}" class="${"svelte-yduzbi"}">Nombre de la via \u{1F448}</label>
          <input type="${"text"}" id="${"street_name"}" class="${"xfill svelte-yduzbi"}" placeholder="${"Ej. Mayor"}" required${add_attribute("value", $userData.street_name, 0)}></div>

        <div class="${"input-wrapper col xfill svelte-yduzbi"}"><label for="${"street_number"}" class="${"svelte-yduzbi"}">N\xFAmero \u{1F448}</label>
          <input type="${"text"}" id="${"street_number"}" class="${"xfill svelte-yduzbi"}" placeholder="${"Ej. 16"}" required${add_attribute("value", $userData.street_number, 0)}></div>

        <div class="${"input-wrapper col xfill svelte-yduzbi"}"><label for="${"cp"}" class="${"svelte-yduzbi"}">C\xF3digo postal \u{1F448}</label>
          <input type="${"text"}" id="${"cp"}" class="${"xfill svelte-yduzbi"}" placeholder="${"Ej. 08818"}" required${add_attribute("value", $userData.cp, 0)}></div>

        <div class="${"input-wrapper col xfill svelte-yduzbi"}"><label for="${"city"}" class="${"svelte-yduzbi"}">Poblaci\xF3n \u{1F448}</label>
          <input type="${"text"}" id="${"city"}" class="${"xfill svelte-yduzbi"}" placeholder="${"Ej. Barcelona"}" required${add_attribute("value", $userData.city, 0)}></div>

        <div class="${"input-wrapper col xfill svelte-yduzbi"}"><label for="${"country"}" class="${"svelte-yduzbi"}">Pa\xEDs \u{1F448}</label>
          <input type="${"text"}" id="${"country"}" class="${"xfill svelte-yduzbi"}" placeholder="${"Ej. Espa\xF1a"}" required${add_attribute("value", $userData.country, 0)}></div></div>

      <div class="${"box round col xfill svelte-yduzbi"}"><h2>Contacto</h2>
        <p class="${"notice svelte-yduzbi"}">Puedes rellenar ambos campos, pero con uno es suficiente</p>

        <div class="${"input-wrapper col xfill svelte-yduzbi"}"><label for="${"phone"}" class="${"svelte-yduzbi"}">Tel\xE9fono</label>
          <input type="${"text"}" id="${"phone"}" class="${"xfill svelte-yduzbi"}" placeholder="${"Ej. 600 600 600"}" required${add_attribute("value", $userData.phone, 0)}></div>

        <div class="${"input-wrapper col xfill svelte-yduzbi"}"><label for="${"email"}" class="${"svelte-yduzbi"}">Correo electr\xF3nico</label>
          <input type="${"text"}" id="${"email"}" class="${"xfill svelte-yduzbi"}" placeholder="${"Ej. hola@facturagratis.com"}" required${add_attribute("value", $userData.email, 0)}></div></div>

      <div class="${"box round col xfill svelte-yduzbi"}"><h2>Impuestos</h2>
        <p class="${"notice svelte-yduzbi"}">Selecciona el tipo de IVA y retenci\xF3n. Si no rellenas el campo de la retenci\xF3n, no la aplicaremos.
        </p>

        <div class="${"input-wrapper col xfill svelte-yduzbi"}"><label for="${"iva"}" class="${"svelte-yduzbi"}">IVA</label>
          <select id="${"iva"}" class="${"xfill svelte-yduzbi"}" required><option value="${"21"}">21%</option><option value="${"10"}">10%</option><option value="${"4"}">4%</option></select></div>

        <div class="${"input-wrapper col xfill svelte-yduzbi"}"><label for="${"ret"}" class="${"svelte-yduzbi"}">Retenci\xF3n (%)</label>
          <input type="${"number"}" id="${"ret"}" class="${"xfill svelte-yduzbi"}" placeholder="${"Ej. 15"}" required${add_attribute("value", $userData.ret, 0)}></div></div></div>` : ``}
</div>`;
});
