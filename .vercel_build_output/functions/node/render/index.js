...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-c30d5000.js",
      css: [assets + "/_app/assets/start-c446e5f0.css"],
      js: [assets + "/_app/start-c30d5000.js", assets + "/_app/chunks/vendor-f8d81c2a.js"]
    },
    fetched: void 0,
    floc: false,
...
var empty = () => ({});
var manifest = {
  assets: [{ "file": "albaranes.svg", "size": 4526, "type": "image/svg+xml" }, { "file": "clientes.svg", "size": 7671, "type": "image/svg+xml" }, { "file": "facturas.svg", "size": 5706, "type": "image/svg+xml" }, { "file": "favicon.png", "size": 856, "type": "image/png" }, { "file": "folders.svg", "size": 18588, "type": "image/svg+xml" }, { "file": "imago.svg", "size": 1117, "type": "image/svg+xml" }, { "file": "logo-192.png", "size": 2908, "type": "image/png" }, { "file": "logo-512.png", "size": 4325, "type": "image/png" }, { "file": "logo-h.svg", "size": 8404, "type": "image/svg+xml" }, { "file": "logo-s.svg", "size": 7315, "type": "image/svg+xml" }, { "file": "logo-v.svg", "size": 8367, "type": "image/svg+xml" }, { "file": "logo.svg", "size": 8028, "type": "image/svg+xml" }, { "file": "menu.svg", "size": 600, "type": "image/svg+xml" }, { "file": "mobile.png", "size": 3074, "type": "image/png" }, { "file": "presupuestos.svg", "size": 24645, "type": "image/svg+xml" }, { "file": "proveedores.svg", "size": 13603, "type": "image/svg+xml" }, { "file": "robots.txt", "size": 70, "type": "text/plain" }],
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-99aeae6b.js", "css": ["assets/pages/__layout.svelte-0c6b0ff6.css"], "js": ["pages/__layout.svelte-99aeae6b.js", "chunks/vendor-f8d81c2a.js", "chunks/stores-5c7418bd.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-9a8f4d20.js", "css": [], "js": ["error.svelte-9a8f4d20.js", "chunks/vendor-f8d81c2a.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-c4661c85.js", "css": ["assets/pages/index.svelte-f528a31d.css"], "js": ["pages/index.svelte-c4661c85.js", "chunks/vendor-f8d81c2a.js"], "styles": [] }, "src/routes/ajustes/index.svelte": { "entry": "pages/ajustes/index.svelte-5b28c4bc.js", "css": ["assets/pages/ajustes/index.svelte-c250dd35.css"], "js": ["pages/ajustes/index.svelte-5b28c4bc.js", "chunks/vendor-f8d81c2a.js", "chunks/stores-5c7418bd.js"], "styles": [] } };
...
var css$3 = {
  code: "nav.svelte-1lms3ad.svelte-1lms3ad{height:65px;border-bottom:1px solid #e6e6e6;padding:0 40px}@media(max-width: 600px){nav.svelte-1lms3ad.svelte-1lms3ad{padding:0 20px}}.logo.svelte-1lms3ad.svelte-1lms3ad{width:200px}li.svelte-1lms3ad.svelte-1lms3ad{padding:0 20px}.active.svelte-1lms3ad.svelte-1lms3ad{border-bottom:2px solid #383838}@media(max-width: 600px){.active.svelte-1lms3ad.svelte-1lms3ad{border-bottom:none;font-weight:bold}}.icon.svelte-1lms3ad.svelte-1lms3ad{width:25px;height:25px;display:none}.mobile-menu.svelte-1lms3ad.svelte-1lms3ad{position:fixed;top:65px;left:0;background:#fff;transition:500ms;z-index:999}.mobile-menu.svelte-1lms3ad li.svelte-1lms3ad{padding:15px 20px;border-bottom:1px solid #e6e6e6}@media(max-width: 600px){.desktop-menu.svelte-1lms3ad.svelte-1lms3ad{display:none}.icon.svelte-1lms3ad.svelte-1lms3ad{display:inherit}}",
  map: '{"version":3,"file":"Nav.svelte","sources":["Nav.svelte"],"sourcesContent":["<script>\\r\\n  import { page } from \\"$app/stores\\";\\r\\n  import { slide } from \\"svelte/transition\\";\\r\\n  import { userData } from \\"../stores\\";\\r\\n\\r\\n  const routes = [\\r\\n    {\\r\\n      slug: \\"/\\",\\r\\n      title: \\"Inicio\\",\\r\\n    },\\r\\n    {\\r\\n      slug: \\"/ajustes\\",\\r\\n      title: $userData.legal_name || \\"Ajustes\\",\\r\\n    },\\r\\n  ];\\r\\n\\r\\n  let mobileMenu = false;\\r\\n\\r\\n  function togMenu() {\\r\\n    mobileMenu = !mobileMenu;\\r\\n  }\\r\\n<\/script>\\r\\n\\r\\n<nav class=\\"row jbetween acenter xfill\\">\\r\\n  <img class=\\"logo\\" src=\\"logo.svg\\" alt=\\"facturasgratis\\" />\\r\\n\\r\\n  <ul class=\\"desktop-menu row yfill\\">\\r\\n    {#each routes as route}\\r\\n      <li class=\\"row acenter yfill\\" class:active={$page.path === route.slug}>\\r\\n        <a href={route.slug}>{route.title}</a>\\r\\n      </li>\\r\\n    {/each}\\r\\n  </ul>\\r\\n\\r\\n  <div class=\\"icon row fcenter\\" on:click={togMenu}>\\r\\n    <img class=\\"fill\\" src=\\"menu.svg\\" alt=\\"Men\xFA\\" />\\r\\n  </div>\\r\\n\\r\\n  {#if mobileMenu}\\r\\n    <ul class=\\"mobile-menu col fill\\" transition:slide>\\r\\n      {#each routes as route}\\r\\n        <li class=\\"row acenter xfill\\" class:active={$page.path === route.slug}>\\r\\n          <a class=\\"row fcenter xfill\\" href={route.slug} on:click={togMenu}>{route.title}</a>\\r\\n        </li>\\r\\n      {/each}\\r\\n    </ul>\\r\\n  {/if}\\r\\n</nav>\\r\\n\\r\\n<style lang=\\"scss\\">nav {\\n  height: 65px;\\n  border-bottom: 1px solid #e6e6e6;\\n  padding: 0 40px;\\n}\\n@media (max-width: 600px) {\\n  nav {\\n    padding: 0 20px;\\n  }\\n}\\n\\n.logo {\\n  width: 200px;\\n}\\n\\nli {\\n  padding: 0 20px;\\n}\\n\\n.active {\\n  border-bottom: 2px solid #383838;\\n}\\n@media (max-width: 600px) {\\n  .active {\\n    border-bottom: none;\\n    font-weight: bold;\\n  }\\n}\\n\\n.icon {\\n  width: 25px;\\n  height: 25px;\\n  display: none;\\n}\\n\\n.mobile-menu {\\n  position: fixed;\\n  top: 65px;\\n  left: 0;\\n  background: #fff;\\n  transition: 500ms;\\n  z-index: 999;\\n}\\n.mobile-menu li {\\n  padding: 15px 20px;\\n  border-bottom: 1px solid #e6e6e6;\\n}\\n\\n@media (max-width: 600px) {\\n  .desktop-menu {\\n    display: none;\\n  }\\n\\n  .icon {\\n    display: inherit;\\n  }\\n}</style>\\r\\n"],"names":[],"mappings":"AAiDmB,GAAG,8BAAC,CAAC,AACtB,MAAM,CAAE,IAAI,CACZ,aAAa,CAAE,GAAG,CAAC,KAAK,CAAC,OAAO,CAChC,OAAO,CAAE,CAAC,CAAC,IAAI,AACjB,CAAC,AACD,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACzB,GAAG,8BAAC,CAAC,AACH,OAAO,CAAE,CAAC,CAAC,IAAI,AACjB,CAAC,AACH,CAAC,AAED,KAAK,8BAAC,CAAC,AACL,KAAK,CAAE,KAAK,AACd,CAAC,AAED,EAAE,8BAAC,CAAC,AACF,OAAO,CAAE,CAAC,CAAC,IAAI,AACjB,CAAC,AAED,OAAO,8BAAC,CAAC,AACP,aAAa,CAAE,GAAG,CAAC,KAAK,CAAC,OAAO,AAClC,CAAC,AACD,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACzB,OAAO,8BAAC,CAAC,AACP,aAAa,CAAE,IAAI,CACnB,WAAW,CAAE,IAAI,AACnB,CAAC,AACH,CAAC,AAED,KAAK,8BAAC,CAAC,AACL,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,OAAO,CAAE,IAAI,AACf,CAAC,AAED,YAAY,8BAAC,CAAC,AACZ,QAAQ,CAAE,KAAK,CACf,GAAG,CAAE,IAAI,CACT,IAAI,CAAE,CAAC,CACP,UAAU,CAAE,IAAI,CAChB,UAAU,CAAE,KAAK,CACjB,OAAO,CAAE,GAAG,AACd,CAAC,AACD,2BAAY,CAAC,EAAE,eAAC,CAAC,AACf,OAAO,CAAE,IAAI,CAAC,IAAI,CAClB,aAAa,CAAE,GAAG,CAAC,KAAK,CAAC,OAAO,AAClC,CAAC,AAED,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACzB,aAAa,8BAAC,CAAC,AACb,OAAO,CAAE,IAAI,AACf,CAAC,AAED,KAAK,8BAAC,CAAC,AACL,OAAO,CAAE,OAAO,AAClB,CAAC,AACH,CAAC"}'
};
var Nav = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_page();
  return `<nav class="${"row jbetween acenter xfill svelte-1lms3ad"}"><img class="${"logo svelte-1lms3ad"}" src="${"logo.svg"}" alt="${"facturasgratis"}">

  <ul class="${"desktop-menu row yfill svelte-1lms3ad"}">${each(routes, (route) => `<li class="${["row acenter yfill svelte-1lms3ad", $page.path === route.slug ? "active" : ""].join(" ").trim()}"><a${add_attribute("href", route.slug, 0)}>${escape(route.title)}</a>
      </li>`)}</ul>

  <div class="${"icon row fcenter svelte-1lms3ad"}"><img class="${"fill"}" src="${"menu.svg"}" alt="${"Men\xFA"}"></div>
...
var _layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  <footer class="${"row fcenter xfill svelte-ripxix"}"><p>Made with \u2665 by verdu on 2021-2022.</p></footer>
</main>`;
});
...
<div class="${"scroll"}"><section class="${"header row fcenter xfill svelte-2ba15b"}"><h1 class="${"svelte-2ba15b"}">Herramientas online para facturaci\xF3n y presupuestos</h1>
    <p class="${"svelte-2ba15b"}">Herramientas online y completamente gratuitas para generar, enviar, rectificar y enlistar facturas, presupuestos, albaranes, clientes, proveedores y productos/servicios. No se necesita instalaci\xF3n.</p></section>

  <ul class="${"tools row jcenter xfill svelte-2ba15b"}">${each(tools, (tool) => `<li class="${"box round col acenter svelte-2ba15b"}"><a class="${"fill"}"${add_attribute("href", tool.slug, 0)}><div class="${"icon svelte-2ba15b"}"><img${add_attribute("src", tool.icon, 0)}${add_attribute("alt", tool.title, 0)}></div>

          <h2 class="${"nowrap xfill svelte-2ba15b"}">${escape(tool.title)}</h2>
          <p class="${"svelte-2ba15b"}">${escape(tool.desc)}</p></a>
      </li>`)}</ul>
</div>`;
});
...
<div class="${"scroll"}"><section class="${"header col fcenter xfill svelte-qkiuan"}"><h1 class="${"svelte-qkiuan"}">Tus datos de facturaci\xF3n</h1>
    <p class="${"svelte-qkiuan"}">En <b>facturagratis</b>, no nos gusta guardar ning\xFAn dato, y menos unos tan sensibles como pueden ser los requeridos para hacer facturas. As\xED pues todos los datos introducidos aqu\xED, solo se guardaran en este navegador.
    </p></section>

  ${$userData ? `<div class="${"info col acenter xfill svelte-qkiuan"}"><div class="${"box round col xfill svelte-qkiuan"}"><h2>Logotipo</h2>
        <p class="${"notice svelte-qkiuan"}">Si usas logotipo en tus facturas, presupuestos o albaranes, aqui es el sitio.</p>

        <div class="${"row xfill"}"><label for="${"logo"}" class="${"file-btn svelte-qkiuan"}">SUBIR IM\xC1GEN</label>

          ${logo ? `<div class="${"file-btn remove-btn svelte-qkiuan"}">BORRAR IM\xC1GEN</div>` : ``}</div>

        <input type="${"file"}" id="${"logo"}" accept="${"image/png, image/jpeg"}" class="${"xfill svelte-qkiuan"}">

        ${logo ? `<div class="${"logo-wrapper row fcenter xfill svelte-qkiuan"}"><img${add_attribute("src", logo, 0)} alt="${"Logotipo"}" class="${"svelte-qkiuan"}"></div>` : ``}</div>

      <div class="${"box round col xfill svelte-qkiuan"}"><h2>Datos legales</h2>
        <p class="${"notice svelte-qkiuan"}">Los campos marcados con un \u{1F448} son obliquos.</p>

        <div class="${"input-wrapper col xfill svelte-qkiuan"}"><label for="${"legal_name"}" class="${"svelte-qkiuan"}">Nombre fiscal \u{1F448}</label>
          <input type="${"text"}" id="${"legal_name"}" class="${"xfill svelte-qkiuan"}" placeholder="${"Ej. Factura Gratis S.L."}" required${add_attribute("value", $userData.legal_name, 0)}></div>

        <div class="${"input-wrapper col xfill svelte-qkiuan"}"><label for="${"legal_id"}" class="${"svelte-qkiuan"}">CIF/NIF \u{1F448}</label>
          <input type="${"text"}" id="${"legal_id"}" class="${"xfill svelte-qkiuan"}" placeholder="${"Ej. B00011100"}" required${add_attribute("value", $userData.legal_id, 0)}></div></div>

      <div class="${"box round col xfill svelte-qkiuan"}"><h2>Direcci\xF3n fiscal</h2>
        <p class="${"notice svelte-qkiuan"}">Los campos marcados con un \u{1F448} son obliquos.</p>

        <div class="${"input-wrapper col xfill svelte-qkiuan"}"><label for="${"street_kind"}" class="${"svelte-qkiuan"}">Tipo de via \u{1F448}</label>
          <input type="${"text"}" id="${"street_kind"}" class="${"xfill svelte-qkiuan"}" placeholder="${"Ej. Calle"}" required${add_attribute("value", $userData.street_kind, 0)}></div>

        <div class="${"input-wrapper col xfill svelte-qkiuan"}"><label for="${"street_name"}" class="${"svelte-qkiuan"}">Nombre de la via \u{1F448}</label>
          <input type="${"text"}" id="${"street_name"}" class="${"xfill svelte-qkiuan"}" placeholder="${"Ej. Mayor"}" required${add_attribute("value", $userData.street_name, 0)}></div>

        <div class="${"input-wrapper col xfill svelte-qkiuan"}"><label for="${"street_number"}" class="${"svelte-qkiuan"}">N\xFAmero \u{1F448}</label>
          <input type="${"text"}" id="${"street_number"}" class="${"xfill svelte-qkiuan"}" placeholder="${"Ej. 16"}" required${add_attribute("value", $userData.street_number, 0)}></div>

        <div class="${"input-wrapper col xfill svelte-qkiuan"}"><label for="${"cp"}" class="${"svelte-qkiuan"}">C\xF3digo postal \u{1F448}</label>
          <input type="${"text"}" id="${"cp"}" class="${"xfill svelte-qkiuan"}" placeholder="${"Ej. 08818"}" required${add_attribute("value", $userData.cp, 0)}></div>

        <div class="${"input-wrapper col xfill svelte-qkiuan"}"><label for="${"city"}" class="${"svelte-qkiuan"}">Poblaci\xF3n \u{1F448}</label>
          <input type="${"text"}" id="${"city"}" class="${"xfill svelte-qkiuan"}" placeholder="${"Ej. Barcelona"}" required${add_attribute("value", $userData.city, 0)}></div>

        <div class="${"input-wrapper col xfill svelte-qkiuan"}"><label for="${"country"}" class="${"svelte-qkiuan"}">Pa\xEDs \u{1F448}</label>
          <input type="${"text"}" id="${"country"}" class="${"xfill svelte-qkiuan"}" placeholder="${"Ej. Espa\xF1a"}" required${add_attribute("value", $userData.country, 0)}></div></div>

      <div class="${"box round col xfill svelte-qkiuan"}"><h2>Contacto</h2>
        <p class="${"notice svelte-qkiuan"}">Puedes rellenar ambos campos, pero con uno es suficiente</p>

        <div class="${"input-wrapper col xfill svelte-qkiuan"}"><label for="${"phone"}" class="${"svelte-qkiuan"}">Tel\xE9fono</label>
          <input type="${"text"}" id="${"phone"}" class="${"xfill svelte-qkiuan"}" placeholder="${"Ej. 600 600 600"}" required${add_attribute("value", $userData.phone, 0)}></div>

        <div class="${"input-wrapper col xfill svelte-qkiuan"}"><label for="${"email"}" class="${"svelte-qkiuan"}">Correo electr\xF3nico</label>
          <input type="${"text"}" id="${"email"}" class="${"xfill svelte-qkiuan"}" placeholder="${"Ej. hola@facturagratis.com"}" required${add_attribute("value", $userData.email, 0)}></div></div>

      <div class="${"box round col xfill svelte-qkiuan"}"><h2>Impuestos</h2>
        <p class="${"notice svelte-qkiuan"}">Selecciona el tipo de IVA y retenci\xF3n. Si no rellenas el campo de la retenci\xF3n, no la aplicaremos.</p>

        <div class="${"input-wrapper col xfill svelte-qkiuan"}"><label for="${"iva"}" class="${"svelte-qkiuan"}">IVA</label>
          <select id="${"iva"}" class="${"xfill svelte-qkiuan"}" required><option value="${"21"}">21%</option><option value="${"10"}">10%</option><option value="${"4"}">4%</option></select></div>

        <div class="${"input-wrapper col xfill svelte-qkiuan"}"><label for="${"ret"}" class="${"svelte-qkiuan"}">Retenci\xF3n (%)</label>
          <input type="${"number"}" id="${"ret"}" class="${"xfill svelte-qkiuan"}" placeholder="${"Ej. 15"}" required${add_attribute("value", $userData.ret, 0)}></div></div></div>` : ``}
</div>`;
});
